...
<div class="container-fluid"
	style="height: 15px; background-color: #006064"></div>
<div class="container-fluid p-3 bg-light">
	<div class="row">
		...
		<div class="col-md-6">
			<form class="form-inline my-2 m  y-lg-0" action="search.jsp"
				method="post">
		...
		<c:if test="${not empty userobj }">
			<div class="col-md-3">
				<a href="Cart.jsp" class="btn text-2x"><i
					class="fa-solid  fa-cart-plus fa-2x"></i>Cart</a> <a href="Login.jsp"
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item active"><a class="nav-link"
				href="AllRecentBook.jsp"><i class="fa-solid fa-book-open"></i>Recent
					Book</a></li>
			<li class="nav-item active"><a class="nav-link"
		...
		<form class="form-inline my-2 my-lg-0">
			<a href="setting.jsp" class="btn btn-Light  my-2 my-sm-0"
				type="submit"> <i class="fa-solid fa-gears"></i> Settings
			</a>
